...
const Onboarding = dynamic(() => import('./_components/Onboarding'), { ssr: false });
...
// 클라이언트 측 상태를 사용하기 위해 별도의 컴포넌트를 만듭니다.
...
//         <h2 className="text-xl font-bold lg:my-4 my-2">행운을 뽑아보자</h2>
//         <Link href="/goodluck">
...
//         <h2 className="text-xl font-bold lg:my-4 my-2">이번주 인기 게시물</h2>
